                    ...
                    Object.keys(wallpapers).map((name, index) => {
                        return (
                            <div 
                                key={index} 
                                tabIndex="1" 
                                onFocus={() => props.changeBackgroundImage(name)} 
...
export const displaySettings = (currBgImgName, changeBackgroundImage) => {
    return <Settings currBgImgName={currBgImgName} changeBackgroundImage={changeBackgroundImage} />;
}
