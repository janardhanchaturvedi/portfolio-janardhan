...
function DefaultMenu(props) {
    return (
        <div id="default-menu" style={{ left: props.x, top: props.y }} className={(props.active ? " block " : " hidden ") + " cursor-default w-52 context-menu-bg border text-left border-gray-900 rounded text-white py-4 absolute z-50 text-sm"}>
